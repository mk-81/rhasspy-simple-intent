...
class _ServiceProxy(): 
	...
	def setup_services(self):
		self.lights        = LightService(self._endpoint_service)
		self.sensors       = SensorService(self._endpoint_service)
		self.media_players = MediaplayerService(self._endpoint_service)
		self.scenes        = SceneService(self._endpoint_service)
